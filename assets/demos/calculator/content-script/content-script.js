...
`;
  ...
  var WinBox = class {
    constructor(params, _title) {
      ...
      body || setup();
      let id, index, root, tpl, title, icon, mount, html, url, shadowel, shadowdom, framename, cssurl, width, height, minwidth, minheight, maxwidth, maxheight, autosize, x, y, top2, left, bottom, right, min2, max2, hidden, modal, background, border, header, classname, oncreate, onclose, onfocus, onblur, onmove, onresize, onfullscreen, onmaximize, onminimize, onrestore, onhide, onshow, onload;
      if (params) {
        if (_title) {
          title = params;
          params = _title;
      ...
      const viewport_h = root_h - top2 - bottom;
      ...
      y = y ? parse(y, viewport_h, height) : top2;
      this.x = x;
      this.y = y;
      this.width = width;
      this.height = height;
